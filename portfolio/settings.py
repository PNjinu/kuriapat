...
AWS_ACCESS_KEY_ID = os.environ.get("AWS_ACCESS_KEY_ID", "")#'AKIAI4LBXIHJD6XF3B4Q'
AWS_SECRET_ACCESS_KEY = os.environ.get("AWS_SECRET_ACCESS_KEY", "") #'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'
AWS_STORAGE_BUCKET_NAME = os.environ.get("AWS_STORAGE_BUCKET_NAME", "") #'kp-portfolio-static'
